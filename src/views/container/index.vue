...
export default {
  ...
  methods: {
    ...
    drawMoon () {
      ...
      this.context.drawImage(moon, -5, -10)
    },
    // 流星雨开始
    MeteorRain: function (_this) {
      ...
      this.draw = function () {
        ...
        // 创建横向渐变颜色,起点坐标至终点坐标
        var line = _this.context.createLinearGradient(this.x, this.y,
          this.x + this.width,
          this.y - this.height)
        // 分段设置颜色
      ...
      this.move = function () {
        ...
        _this.context.clearRect(x - 3, y - 3, this.offset_x + 5, this.offset_y + 5)
